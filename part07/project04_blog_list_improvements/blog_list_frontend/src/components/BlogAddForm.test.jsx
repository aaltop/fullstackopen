...
describe("BlogAddForm element", () => {
    ...
    function renderElement() {
        ...
        render(<BlogAddForm submitAction={submitAction} />)
    ...
    test("submits correct values", () => {
        ...
        const inputs = inputLabels.map(val =>
            screen.getByLabelText(val)
        )
        ...
        const passedArguments =
            submitAction.mock.lastCall.slice(1)
